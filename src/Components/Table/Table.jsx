...
export default function Table() {
    ...
    const handleRussianEdit = (e) =>{
        const newRussian = e.target.value
        setRussianInputValue(newRussian);
            ...
            <tbody>
                {data.map((item) => (
                    <tr key={item.id}>
                        {rowEditing === item.id ? (
                            <>
                                <td><input type="text" value={englishInputValue || item.english} onChange = {handleEnglishEdit}/></td>
                                <td><input type="text" value={transcriptionInputValue || item.transcription} onChange = {handleTranscriptionEdit}/></td>
                                <td><input type="text" value={russianInputValue || item.russian} onChange = {handleRussianEdit}/></td>
                                <td>
